...
console.log('Is blockchain valid ' +  manish.isChainValid());
manish.chain[1].data={amount:100};
manish.chain[1].hash=manish.chain[1].calculateHash();
//console.log(JSON.stringify(manish,null,4));